    ...
    public class InstructionTests
    {
        ...
        public void Test_NewInstruction()
        {
            ...
            TestData[] testData = new TestData[]
            {
                    ...
                    new TestData { Instr = 0xfe010113, Want = new Instruction { Type= InstructionType.I, Imm = 4294967264, Funct7 = 127, Rs2 = 0, Rs1 = 2, Funct3 = 0, Rd = 2, Opcode = (byte)(0xfe010113 & 0b1111111) } },
                    // 8000008c: 23 2e 11 00   sw      ra, 28(sp)
                    new TestData { Instr = 0x00112e23, Want = new Instruction { Type = InstructionType.S, Imm = 28, Funct7 = 0, Rs2 = 1, Rs1 = 2, Funct3 = 2, Rd = 28, Opcode = (byte) (0x00112e23 & 0b1111111) } },
                    ...
                    new TestData { Instr = 0xf78080e7, Want = new Instruction { Type = InstructionType.I, Imm = 0xFFFFFF78, Funct7 = 123, Rs2 = 24, Rs1 = 1, Funct3 = 0, Rd = 1, Opcode = (byte)(0xf78080e7 & 0b1111111) } },
                    ...
                    new TestData { Instr = 0x050000ef, Want = new Instruction { Type = InstructionType.J, Imm = 0x50, Funct7 = 2, Rs2 = 16, Rs1 = 0, Funct3 = 0, Rd = 1, Opcode = 0x050000ef & 0b1111111 } },
                    // 80000084: 67 80 00 00   ret
                    //  ret -> jalr zero, ra, 0
                    new TestData { Instr = 0x00008067, Want = new Instruction { Type = InstructionType.I, Imm = 0, Funct7 = 0, Rs2 = 0, Rs1 = 1, Funct3 = 0, Rd = 0, Opcode = 0x00008067 & 0b1111111 } },
                    //       28: 63 00 00 00   beqz    zero, 0x28 <.Lline_table_start0+0x28>
                    new TestData { Instr = 0x00000063, Want = new Instruction { Type = InstructionType.B, Imm = 0, Funct7 = 0, Rs2 = 0, Rs1 = 0, Funct3 = 0, Rd = 0, Opcode = 0x00000063 & 0b1111111 } },
                    // 800000ac: 97 00 00 00   auipc   ra, 0
                    new TestData { Instr = 0x00000097, Want = new Instruction { Type = InstructionType.U, Imm = 0, Funct7 = 0, Rs2 = 0, Rs1 = 0, Funct3 = 0, Rd = 1, Opcode = 0x00000097 & 0b1111111 } },
                    //       3c: 73 63 76 31   csrrsi  t1, 791, 12
                    new TestData { Instr = 0x31766373, Want = new Instruction { Type = InstructionType.C, Imm = 0, Funct7 = 24, Rs2 = 23, Rs1 = 12, Funct3 = 6, Rd = 6, Opcode = 0x31766373 & 0b1111111 } },
            };

            foreach (var td in testData)
            {
                var got = new Instruction(td.Instr);
                if (!got.Equals(td.Want))
                {
                    throw new Exception($"NewInstruction failed for 0x{td.Instr:X}. got:{got}, want:{td.Want}");
                }
            }
        }
